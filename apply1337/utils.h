...
inline void string_to_lower(std::string& data)
{
...
private:
    static std::string get_message(const char* function, DWORD error_code)
    {
    ...
    static std::string get_winapi_error_message(DWORD error_code)
    {
        char* buffer;
